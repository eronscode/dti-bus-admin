...
render(){
   return(
    <React.Fragment>
        ...
        <SideDrawer username={this.props.userData.fullname} isVerify={this.props.isVerify}  isAuth={this.props.isAuth} open={this.state.showSideDrawer} closeDrawer={this.closeSideDrawerHandler}/>
